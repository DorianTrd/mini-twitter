...
import PostList, { type Post } from "../components/PostList.tsx"
...
function Home() {
    ...
    useEffect(() => {
        ...
        const handleOnline = () => {
            toastr.success("Vous êtes à nouveau en ligne. Vos posts ont été envoyés avec succès.", "Connexion restaurée")
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-4">
            ...
            <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-lg mt-6">
                ...
                />
                {imagePreview && (
                    <img src={imagePreview || "/placeholder.svg"} alt="Aperçu" className="max-w-full h-auto rounded-lg mb-4" />
                )}
